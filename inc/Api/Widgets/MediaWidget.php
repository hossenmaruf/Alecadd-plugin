...
class MediaWidget extends WP_Widget
{
	...
	function __construct() {
		...
		$this->widget_ID = 'alecadd_media_widget';
		$this->widget_name = 'Alecadd Media Widget';
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Custom Text', 'hossenmaruf' );
		$image = ! empty( $instance['image'] ) ? $instance['image'] : '';
		?>
<p>
    <label
        for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_attr_e( 'Title:', 'hossenmaruf' ); ?></label>
...
<p>
    <label
        for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php esc_attr_e( 'Image:', 'hossenmaruf' ); ?></label>
