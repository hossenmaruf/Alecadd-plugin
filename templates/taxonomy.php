<div class="wrap">
    ...
    <ul class="nav nav-tabs">
        <li class="<?php echo !isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>"><a href="#tab-1">Your Taxonomies</a>
        </li>
    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane <?php echo !isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
            ...
            <?php 
				// $options = get_option( 'alecadd_plugin_cpt' ) ?: array();
				...
				// 	settings_fields( 'alecadd_plugin_cpt_settings' );
        ...
        <div id="tab-2" class="tab-pane <?php echo isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
            <form method="post" action="options.php">
                <?php 
					...
					do_settings_sections( 'alecadd_taxonomy' );
					submit_button();
				?>
            </form>
        </div>
